...
open class CatalogCustomAttributeDefinition: Codable {
    ...
    public var AllowedObjectTypes: [CatalogObjectType]?
    ...
    public var SellerVisibility: CatalogCustomAttributeDefinitionSellerVisibility?
    /// - AppVisibility: The visibility of a custom attribute to applications other than the application that created the attribute.
    public var AppVisibility: CatalogCustomAttributeDefinitionAppVisibility?
