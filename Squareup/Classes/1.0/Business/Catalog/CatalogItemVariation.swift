...
open class CatalogItemVariation: Codable {
    ...
    var PricingType: CatalogPricingType?
    ...
    var LocationOverrides = [ItemVariationLocationOverrides]()
    ...
    var ItemOptionValues = [CatalogItemOptionValueForItemVariation]()
    ...
    var StockableConversion: CatalogStockConversion?
    ...
    var ItemVariationVendorInfoIds = [String]()
