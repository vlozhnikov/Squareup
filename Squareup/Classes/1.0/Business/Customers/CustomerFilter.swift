...
open class CustomerFilter: Codable {
    ...
    var CreationSource: CustomerCreationSourceFilter?
    ...
    var EmailAddress: CustomerTextFilter?
    ...
    var PhoneNumber: CustomerTextFilter?
    /// - ReferenceId:
    ...
    var ReferenceId: CustomerTextFilter?
    ...
    var CustomAttribute: CustomerCustomAttributeFilters?
