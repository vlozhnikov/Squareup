...
/// - GiftCardActivityLoad: Represents details about a LOAD gift card activity type.
/// https://developer.squareup.com/reference/square/objects/GiftCardActivityLoad
open class GiftCardActivityLoad: Codable {
