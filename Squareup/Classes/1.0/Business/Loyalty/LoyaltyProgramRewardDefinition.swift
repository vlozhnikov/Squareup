...
open class LoyaltyProgramRewardDefinition: Codable {
    ...
    var Scope: LoyaltyProgramRewardDefinitionScope?
    ...
    var DiscountType: LoyaltyProgramRewardDefinitionType?
