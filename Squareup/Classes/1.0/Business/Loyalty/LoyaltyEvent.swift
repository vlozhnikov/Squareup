...
//    var CreatedAt: Date?
    ...
    var CreateReward: LoyaltyEventCreateReward?
    /// - RedeemReward:
    var RedeemReward: LoyaltyEventRedeemReward?
    /// - DeleteReward: Read only Provides metadata when the event type is DELETE_REWARD.
    var DeleteReward: LoyaltyEventDeleteReward?
