...
open class OrderReturnServiceCharge: Codable {
    ...
    /// Max Length 60
    var SourceServiceChargeUid: String?
    ...
    var CalculationPhase: OrderServiceChargeCalculationPhase?
    ...
    var TreatmentType: OrderServiceChargeTreatmentType?
    ...
    var Scope: OrderServiceChargeScope?
