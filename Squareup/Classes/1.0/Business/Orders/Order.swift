...
open class Order: Codable {
    ...
    var ServiceCharges: [OrderServiceCharge]?
    ...
    var NetAmounts: OrderMoneyAmounts?
...
//    var ClosedAt: Date?
    ...
    var PricingOptions: OrderPricingOptions?
